...
public class Imovel {
    ...
    public Imovel(Integer id, String tipo, String endereco, String cidade, String estado, String cep,
                  double metragem, int quartos, int banheiros, int vagas,
                  boolean mobiliado, boolean ativo, boolean disponivel) {
        this.id = id;
        this.tipo = tipo;
    ...
    public Imovel(String tipo, String endereco, String cidade, String estado, String cep,
                  double metragem, int quartos, int banheiros, int vagas,
                  boolean mobiliado, boolean ativo, boolean disponivel) {
        this(null, tipo, endereco, cidade, estado, cep, metragem, quartos, banheiros, vagas, mobiliado, ativo, disponivel);
    }
    ...
    public String toString() {
        return String.format("#%d - %s | %s, %s-%s | %.2f m² | Q:%d B:%d V:%d | Mob:%s | Ativo:%s | Disp:%s",
                id, tipo, endereco, cidade, estado, metragem, quartos, banheiros, vagas,
                mobiliado ? "Sim" : "Não", ativo ? "Sim" : "Não", disponivel ? "Sim" : "Não");
    }
}
