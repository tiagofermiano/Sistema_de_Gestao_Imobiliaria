...
public class ImovelDAO {
    ...
    private Imovel map(ResultSet rs) throws SQLException {
        return new Imovel(rs.getInt("id"), rs.getString("tipo"), rs.getString("endereco"), rs.getString("cidade"),
                rs.getString("estado"), rs.getString("cep"), rs.getDouble("metragem"), rs.getInt("quartos"),
                rs.getInt("banheiros"), rs.getInt("vagas"), rs.getInt("mobiliado") == 1, rs.getInt("ativo") == 1,
